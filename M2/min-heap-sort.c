...
//This is sortTree() function as mention in the problem.
...
int getMin()
{
    int minValue = heap[0];
    heapCurrSize--;
    heap[0] = heap[heapCurrSize];
    perlocateDown(0); //this is sortTree() function from the problem, but I didn't change the name because it's confusing
    return minValue;
}
